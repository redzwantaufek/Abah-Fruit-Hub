...
if (!$header) {
    echo "<div class='container mt-5'><div class='alert alert-danger'>Order tidak dijumpai!</div></div>";
    exit();
}
?>

<div class="container mt-4">
    <a href="orders.php" class="btn btn-light mb-3 shadow"><i class="fas fa-arrow-left"></i> Kembali</a>
    <button onclick="window.print()" class="btn btn-success mb-3 ms-2 shadow">
    ...
    <div class="glass-card">
        <div class="row mb-4 border-bottom pb-3">
            <div class="col-md-6">
                ...
                <p class="text-muted mb-0">Tarikh: <?php echo date('d-m-Y', strtotime($header['ORDERDATE'])); ?></p>
            </div>
            <div class="col-md-6 text-end">
                <h5 class="fw-bold"><?php echo $header['CUSTNAME']; ?></h5>
                <p class="mb-0">Jurujual: <?php echo $header['STAFFNAME']; ?></p>
            </div>
        </div>

        <h5 class="mb-3">Senarai Barang Dibeli:</h5>
        <table class="table table-bordered">
            ...
            <tbody>
                <?php
                $sql_detail = "SELECT d.Quantity, f.FruitName, f.FruitPrice
                               FROM ORDERDETAILS d
                               JOIN FRUITS f ON d.FruitId = f.FruitId
                               WHERE d.OrderId = :oid";
            ...
            <tfoot class="table-dark">
                <tr>
                    ...
                    <td><strong>RM <?php echo number_format($grand_total, 2); ?></strong></td>
                </tr>
            </tfoot>
        </table>
    </div>
